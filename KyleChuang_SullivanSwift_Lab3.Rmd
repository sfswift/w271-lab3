...
Reviewing the plots of the data we detrended and deseasonalized, we confirm that the time series to have been detrended and deseasonalized. On the PACF plot, there appears to strong serial quarterly correlation as it oscillates towards zero. The ACF plot has high serial correlation at the 4th lag. The strong ACF at lag 4 and cycling towards 0 in pact suggest there is a seasonal MA(1) [SMA1] component. 
...
We first note that these model are very similar. The $SARIMA(0,1,0)(0,1,2)_4$ is invertible to $SARIMA(0,1,0)(2,1,0)_4$ from invertibility of MA models.  We note the roots of the $SARIMA(0,1,0)(0,1,2)_4$ are `r round(Mod(polyroot(c(1,-0.77,0.4))),2)` and the roots of $SARIMA(0,1,0)(2,1,0)_4$ are `r Mod(polyroot(c(1,0.8,0.25)))`. Both models are quite similar. 
